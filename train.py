...
tf.flags.DEFINE_integer( "sequence_length" , 40 , "the max of words in a sentence" )
...
#=====================================
"""
x_data , y_data = datapre.load_data_label(FLAGS.dataPath , FLAGS.stopwordsPath , FLAGS.w2vModelPath , FLAGS.sequence_length)
...
with tf.Graph().as_default() :
	...
	batches = datapre.batch_iter( list(zip( x_train , y_train ) )  , FLAGS.batch_size , FLAGS.num_epochs , shuffle = True )

	for batch in batches :
		x_batch , y_batch = zip( *batch )
		# print type( x_batch )
		# x_batch1 = tf.reshape( np.array( x_batch ) , [ - 1 , FLAGS.sequence_length , FLAGS.embedding_dim ] )
	
		# print type( x_batch1 )
		# x_batch2 = np.array( x_batch1 )
		# print type( x_batch2 )
